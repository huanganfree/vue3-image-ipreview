<template>
  <div class="ha-image-preview_content" @mousewheel.stop="handleMousewheel">
    ...
    <div class="ha-image-preview_viewer" @mouseup.stop="handlePreviewViewerMouseUp"
      @mousedown.stop="handlePreviewViewerMouseDown" ref="preview_viewer" draggable="false">
      <img :src="currentImg.url" alt="" :style="previewImageStyle" ref="previewImage" draggable="false"
